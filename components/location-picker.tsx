...
export function LocationPicker({
  ...
  const copyCoords = useCallback(async () => {
    ...
    try {
      ...
      setNotice(null);
      setError(t("location.copyFailed"));
    }
  }, [selectedLocation, t]);
      ...
      <CardContent className="relative space-y-5">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-sm font-semibold text-foreground truncate">
                    {selectedLocation.address || t("location.selectedLocation")}
                  </div>
                </div>
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <Badge variant="secondary" className="rounded-full">
                {isAdvancedOpen ? t("location.open") : t("location.closed")}
              </Badge>
              {isAdvancedOpen ? (
        ...
        >
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <Badge variant="secondary" className="rounded-full">
                {isMapOpen ? t("location.open") : t("location.closed")}
              </Badge>
              {isMapOpen ? (
                <ChevronUp className="h-4 w-4 text-muted-foreground" />
              ) : (
